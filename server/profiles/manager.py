...
## ข้อมูลเบื้องต้น
- **ชื่อมังงะ (ไทย)**: [ใส่ชื่อภาษาไทยที่นี่]
- **ชื่อมังงะ (ต้นฉบับ)**: [ใส่ชื่อต้นฉบับที่นี่]
- **โทนเรื่อง**: [เช่น ตลก / แอคชั่น / โรแมนติก / สยองขวัญ]

## รายชื่อตัวละครและสรรพนาม
| ชื่อต้นฉบับ | ชื่อไทย | สรรพนาม (พูดแทนตัว) | สรรพนาม (เรียกคนอื่น) | รายละเอียดบุคลิก |
|---|---|---|---|---|
| [ชื่อตัวละครต้นฉบับ] | [ชื่อไทย] | [เช่น ฉัน/ผม/กู/ข้า] | [เช่น นาย/แก/คุณ] | [บุคลิกโดยย่อ] |

## คลังคำศัพท์เฉพาะ (Glossary)
| คำศัพท์ต้นฉบับ | คำแปลภาษาไทย | รายละเอียด/บริบท |
|---|---|---|
| [คำศัพท์เฉพาะ] | [คำแปล] | [บริบทการใช้งาน] |

## กฎการแปลเพิ่มเติม
- [ใส่กฎพิเศษของมังงะเรื่องนี้ที่นี่ เช่น วิธีแปล SFX หรือสำนวนเฉพาะ]
"""
            try:
